...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (isset($_POST['add_category'])) {
        // Handle category addition (would need file upload handling in real implementation)
...
<head>
    ...
    <title>Manage Categories - Shakti Bites Admin</title>
    <!-- Bootstrap 5.3.3 CSS -->
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <form method="POST" action="" class="d-inline">
                                                            ...
                                                            <button type="submit" name="toggle_status" class="btn btn-sm btn-<?php echo $category['is_active'] ? 'outline-success' : 'outline-secondary'; ?>">
                                                    ...
                                                    <td>
                                                        <div class="btn-group">
                                                            <button type="button" class="btn btn-sm btn-outline-primary" data-bs-toggle="modal" data-bs-target="#editCategoryModal<?php echo $category['id']; ?>">
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <form id="editCategoryForm<?php echo $category['id']; ?>">
                                                <input type="hidden" name="category_id" value="<?php echo $category['id']; ?>">
                                                <div class="mb-3">
                                                ...
                                                <div class="mb-3">
                                                    <label for="image<?php echo $category['id']; ?>" class="form-label">Image Filename</label>
                                                    <input type="text" class="form-control" id="image<?php echo $category['id']; ?>" name="image" value="<?php echo htmlspecialchars($category['image']); ?>" placeholder="e.g., category1.jpg">
                                                </div>
                                                <div class="mb-3">
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="checkbox" id="is_active<?php echo $category['id']; ?>" name="is_active" <?php echo $category['is_active'] ? 'checked' : ''; ?>>
                                                        <label class="form-check-label" for="is_active<?php echo $category['id']; ?>">
                                                            Active
                                                        </label>
                                                    </div>
                                                </div>
...
<script>
    ...
    // Add category form submission (placeholder - would need actual PHP endpoint)
    ...
    // Edit category form submissions (placeholder)
    document.querySelectorAll('[id^="editCategoryForm"]').forEach(form => {
        form.addEventListener('submit', function(e) {
            e.preventDefault();
            alert('Category updated successfully! (This is a demo - form not connected to backend)');
